...
export const BLUEPRINT=Object.freeze({
  ...
  tools:Object.freeze([
    'The crowbar from Mechanical lifts the cover.',
    'Water Filtration keeps the service kit: split collar, seal and torque wrench. Look behind the pump controls.',
  ]),
...
export class GeorgeTerminal{
  ...
  insertDrive(hasHardDrive){
    ...
    this.drive=true;this.booted=false;this.notice='CARTRIDGE SEATED.';return true;
  }
  ejectDrive(){
  ...
  blocked(path){return (!this.found&&(path==='/LIBRARY'||path.startsWith('/LIBRARY/')))||(!this.opened&&path.startsWith('/LIBRARY/'));}
